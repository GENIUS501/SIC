...
namespace SIC
{
    public partial class Visor_Reporte_Expediente_Numero : Form
    {
        public string Usuario { get; set; }
        public string Num_Expediente { get; set; }

        public Visor_Reporte_Expediente_Numero()
        {
            InitializeComponent();
        }

        private void Visor_Reporte_Expediente_Numero_Load(object sender, EventArgs e)
        {
            try
            { 
                ...
                parameters[1] = new ReportParameter("Num_Expediente", Num_Expediente.ToString());

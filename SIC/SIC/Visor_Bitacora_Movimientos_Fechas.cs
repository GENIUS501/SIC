...
namespace SIC
{
    public partial class Visor_Bitacora_Movimientos_Fechas : Form
    {
        public DateTime fechaini { get; set; }
        public DateTime fechafin { get; set; }
        public string Usuario { get; set; }
        public Visor_Bitacora_Movimientos_Fechas()
        {
            InitializeComponent();
        }

        private void Visor_Bitacora_Movimientos_Fechas_Load(object sender, EventArgs e)
        {
            try
